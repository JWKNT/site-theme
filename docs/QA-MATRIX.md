...
| Grouped recordings | Open/close worlds, extras/letter codes, cross-world and empty search, Clear/Escape, deep links/history, no JS and print | All recordings remain linked once; current world opens without autoplay; clearing search restores disclosures; keyboard reaches expanded links only; print includes closed and filtered records |
