...
| Recording catalogue | Play/seek, switch/reselect, deep link, Back/Forward, skip target, modified clicks, PiP rejection, no JS | One native player; no autoplay; title/poster/duration/download stay synchronized; repeat selection preserves playback/history; unrelated fragments keep the clip; native MP4 fallback remains |
| Playback speed | Every preset, keyboard activation, native rate change, playing/paused, switch clip, narrow/200% text, no JS | Actual media rate and pressed state agree; no autoplay or seek; rate survives clip selection; buttons wrap without clipping and stay hidden without enhancement |
| Grouped recordings | Open/close worlds, extras/letter codes, deep links/history, no JS and print; quiet divider | All recordings remain linked once; current world opens without autoplay; keyboard reaches expanded links only; print includes closed worlds; no search or dedicated PiP button; divider is distinct from the masthead with no opaque backdrop |
