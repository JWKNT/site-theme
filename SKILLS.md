...
These are six working, focused skills, not a wish list. Their source of truth is
...
The first command is a dry run. The second links the six maintained directories
...
all six. Installation does not grant permission to publish or run the game bot.
